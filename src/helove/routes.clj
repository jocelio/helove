(ns helove.routes
    (:use [compojure.core :only [defroutes GET POST DELETE ANY context]]
          ...
          [helove.middleware :only [wrap-failsafe wrap-request-logging-in-dev
                                              wrap-reload-in-dev JGET JPUT JPOST JDELETE]])
    (:require [helove.handlers.app :as app]
              [helove.handlers.videos :as videos]
              [helove.handlers.api :as api]
